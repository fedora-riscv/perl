...
Patch118:       perl-5.31.7-error-check-the-calls-to-sigaddset-in-POSIX-SigSet-n.patch

# Fix thread-safety of IO::Handle, GH#14816, in upstream after 5.31.7
Patch119:       perl-5.31.7-Add-tests-for-IO-Handle-getline-and-getlines.patch
...
# in upstream after 5.31.8
Patch127:       perl-5.28.2-toke.c-fix-Multidimensional-array-heuristic-to-ignor.patch

# Fix a warning about an uninitialized value in B::Deparse, GH#17537
Patch128:       perl-5.31.9-B-Deparse-fixup-uninitialized-error-in-deparsing-wei.patch
...
%endif
    ...
    'Fedora Patch118: Prevent from an integer overflow in POSIX::SigSet()' \
    'Fedora Patch119: Fix thread-safety of IO::Handle (GH#14816)' \
    ...
    'Fedora Patch127: Fix a spurious warning about a multidimensional syntax (GH#16535)' \
    'Fedora Patch128: Fix a warning about an uninitialized value in B::Deparse (GH#17537)' \
...
* Fri Jul 19 2019 Petr Pisar <ppisar@redhat.com> - 4:5.28.2-438
- Define %%perl_vendor*, %%perl_archlib, %%perl_privlib, because in rpm
  4.15 those are no longer defined

* Thu Jul 18 2019 Petr Pisar <ppisar@redhat.com> - 4:5.28.2-437
- Do not panic when evaluating non-ASCII bare words (RT#134061)
- Fix a crash in SIGALARM handler when waiting on a child process to be closed
  (RT#122112)
- Fix a crash with a negative precision in sprintf function (RT#134008)
